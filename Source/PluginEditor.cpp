...
//==============================================================================
PKPlusAudioProcessorEditor::PKPlusAudioProcessorEditor(PKPlusAudioProcessor& p)
...
PKPlusAudioProcessorEditor::~PKPlusAudioProcessorEditor() = default;

//==============================================================================
void PKPlusAudioProcessorEditor::paint(juce::Graphics& g) 
{
    g.drawImage(backgroundImage, 0, 0, getWidth(), getHeight(), 
        0, 0, backgroundImage.getWidth(), backgroundImage.getHeight());
}

void PKPlusAudioProcessorEditor::resized() 
{
    auto* p = dynamic_cast<PKPlusAudioProcessor*>(&processor);
...
void PKPlusAudioProcessorEditor::initIntervalsPanel(NoteParam& noteParam)
    {
...
void PKPlusAudioProcessorEditor::updateNoteEdited(const int index)
{
    for (auto& noteKey: keysPanel.noteKeys) 
    {
