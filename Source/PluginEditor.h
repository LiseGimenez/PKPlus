...
class PKPlusAudioProcessorEditor : public juce::AudioProcessorEditor
{
public:
    explicit PKPlusAudioProcessorEditor(PKPlusAudioProcessor&);
    ~PKPlusAudioProcessorEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(PKPlusAudioProcessorEditor)
};
